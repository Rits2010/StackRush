    ...
    const loadChallenge = async () => {
      ...
      try {
        ...
        const transformedChallenge: Challenge = {
          ...
          testCases: challengeData.code?.testCases?.map(tc => ({
            input: tc.input,
              ...
              {showPreview && challengeType === 'bug-fix' && (
                <div className="w-1/2 border-l border-slate-200/30 dark:border-slate-700/30 bg-white/80 dark:bg-slate-900/80 flex flex-col backdrop-blur-xl">
                  ...
                  <div className="flex-1 p-4">
                    <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 h-full">
                      <div className="space-y-4">
                        <div>
                          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Test Email</label>
                          <input
                            type="text"
                            placeholder="user+test@example.com"
